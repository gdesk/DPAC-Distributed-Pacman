...
/**
 * A class wich implements the GamePanelView interface
 * Created by Chiara Varini on 10/07/17.
 */
public class GamePanel extends JLayeredPane implements GamePanelView {
    ...
    public GamePanel(final PlaygroundPanel playground) {
