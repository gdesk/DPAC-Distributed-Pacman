...
/**
 * a class to simulate peer to peer communication
 */
/*public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final Peer peer1 = new PeerImpl(1,9090);
        final Peer peer2 = new PeerImpl(2, 9091);
        final Peer peer3 = new PeerImpl(3,9092);
